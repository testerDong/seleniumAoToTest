...
public class ExtentTestNGIReporterListener implements IReporter {
	...
	private static Logger logger = Logger.getLogger(ExtentTestNGIReporterListener.class);
    ...
    public void generateReport(List<XmlSuite>  xmlSuites, List<ISuite> suites, String outputDirectory) {
        ...
        extent.flush();
        logger.info("生成ExtentHtmlReporter报告成功！");
		...
		logger.info("ExtentHtmlReporter报告邮件发送成功！");
    }
